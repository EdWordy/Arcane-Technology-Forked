    ...
    class ArcaneTechnologySettings : ModSettings
    {
        ...
        public static void DrawSettings(Rect rect)
        {
            ...
            if (restrictOnTechLevel)
            {
                ...
                ls.Gap();
                a = ls.RadioButton("Highest tech researched", useHighestResearched, tooltip: "If you have even one tech in a tech level researched, you will be considered that tech for the purpose of raids.");
                ls.Gap();
                b = ls.RadioButton("Tech completion of a certain percent", usePercentResearched, tooltip: "Once you research a certain % of a tech level's available technologies, you will be considered that tech level for the purpose of raids.");
                ...
                c = ls.RadioButton("Actual colonist tech level", useActualTechLevel, tooltip: "Not recommended unless you have a mod to increase your tech level somehow.");
